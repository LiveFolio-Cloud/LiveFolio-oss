...
export default function CommentsView({
  ...
  // Prose form: "just now", "5m ago" — see lib/format-time for the other
  // surfaces' wording (the comments panel uses the compact "now" / "5m").
  const formatTime = (isoString: string) =>
    formatRelativeTime(isoString, { nowLabel: 'just now', suffix: ' ago' });
