...
const TYPOGRAPHY_PAIRINGS = [
  ...
  // Was 'Cabinet Grotesk & Inter'. Cabinet Grotesk is not loadable from this
  // app: there is no font file in public/fonts/, it is not an @fontsource
  // package (only space-grotesk and plus-jakarta-sans are), and its CDN
  // (api.fontshare.com) is not in the CSP — only Google Fonts is. A folio told
  // to use it rendered a fallback. Space Grotesk is what the brand stack
  // actually falls back to, and it loads from Google Fonts.
  { name: 'Space Grotesk & Inter', heading: 'Space Grotesk', body: 'Inter' },
];
