...
import { LS_KEYS, readLocalStorage, writeLocalStorage } from '@/lib/use-local-storage';
...
export default function CodeView({
  ...
  React.useEffect(() => {
    if (editorCode) writeLocalStorage(LS_KEYS.codeDraft, editorCode);
  }, [editorCode]);

  // Restore draft on mount
  React.useEffect(() => {
    const saved = readLocalStorage(LS_KEYS.codeDraft);
