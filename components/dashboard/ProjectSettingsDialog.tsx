...
// From ./paid-access, NOT ./config — config imports Supabase, and this dialog
// is reachable from the /app shell layout, so importing from there put the
// whole SDK in the app-shell bundle.
import { sanitizePaidAccess } from '@/lib/gating/paid-access';
