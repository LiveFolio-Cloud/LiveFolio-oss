...
**How this repo is maintained:** this tree is a released edition of LiveFolio,
not a development branch — it receives periodic, verified updates from the
maintainers, and every published revision is self-consistent (what you clone
is what runs). PRs and issues are welcome; accepted changes land in a future
release.
