...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  h1{font-family:'Space Grotesk',sans-serif;font-size:24px;font-weight:700;letter-spacing:-.035em;line-height:1.1}
  ...
  .party-name{font-family:'Space Grotesk',sans-serif;font-size:11px;font-weight:700;letter-spacing:-.01em;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
...
export async function GET(request: Request) {
  ...
  const supabase = await sessionSupabaseClient();
