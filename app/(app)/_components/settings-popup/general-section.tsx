...
// NOTE: `@/lib/supabase` is imported dynamically inside the banner-upload
// handler rather than here — the SDK is ~59 KB gzip and only the (rare)
// upload needs it, not the settings popup's first render.
...
function ProfileRows() {
  ...
  const uploadBanner = async (file: File) => {
    ...
    try {
      // Dynamic: the banner upload is the only Supabase call in this popup —
