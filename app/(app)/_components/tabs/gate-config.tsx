...
/**
 * Paid-gating configuration block — shared by the Share menu's
...
// NOTE: `@/lib/supabase` is imported dynamically inside the thumbnail upload
// handler rather than here — the SDK is ~65 KB gzip and only the (rare)
// thumbnail upload needs it, not the settings panel's first render.
