...
// Flag only — dependency-free probe (see lib/supabase-config.ts).
...
function RegisterForm() {
  ...
  // Fetched on demand: `@supabase/ssr` is ~65 KB gzip and nothing on this page
  // needs it until the user submits. Same singleton as before —
  // lib/supabase.ts caches the client per url+key in a window-global map.
