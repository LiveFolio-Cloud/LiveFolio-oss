/* -------------------------------------------------------------------------- */
/* Self-hosted stub for lib/conversion-tracking.ts (cloud-only analytics —    */
/* GA4, Meta Pixel, LinkedIn Insight Tag, PostHog). The cloud module is        */
/* excluded from the self-hosted build and this stub is swapped in under the  */
/* real filename, with an identical export surface so shipped files           */
/* (app/register) keep compiling. All calls are no-ops — it ships zero        */
/* tracking.                                                                  */
/* -------------------------------------------------------------------------- */
